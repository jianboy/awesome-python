...
* 静态分析、短绒和代码质量检查工具。另请参阅 [令人敬畏的静态分析](https://github.com/mre/令人敬畏的静态分析)。*
...
* [探矿者](https://github.com/PyCQA/prospector) -分析Python代码的工具。
...
* 静态类型检查器，另请参阅 [真棒-python-typing](https://github.com/typeddjango/真棒-python-typing)
...
* 命令行应用程序开发
* [水泥](http://builtoncement.com/) -Python的CLI应用程序框架。
...
* [烧瓶-调试工具栏](https://github.com/mgood/烧瓶-调试工具栏)-django-调试工具栏到烧瓶的端口。
...
* SSH风格的部署
* [美食](https://github.com/sebastien/cuisine) -类似厨师的面料功能。
* [fabric](https://github.com/fabric/fabric) -用于远程执行和部署的简单Pythonic工具。
* [fabtools](https://github.com/fabtools/fabtools) -编写真棒结构文件的工具。
* 流程管理
...
* [椰子](https://github.com/evhub/coconut) -Python的一种变体，用于简单，优雅，Pythonic函数编程。
...
* [更多-itertools](https://github.com/erikrose/更多-itertools) -除了 “itertools” 之外，更多用于对iterables进行操作的例程。
...
* [石墨烯](https://github.com/graphql-python/石墨烯/) -Python的GraphQL框架。
...
* [聚光灯](https://github.com/maciejkula/spotlight) -使用PyTorch的深度推荐模型。
* [惊喜](https://github.com/NicolasHug/Surprise) -用于构建和分析推荐系统的scikit。
